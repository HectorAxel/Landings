...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#image02', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image06', { style: 'fade-right', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image08', { style: 'blur-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'tilt-right', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image05', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image07', { style: 'blur-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image03', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image04', { style: 'fade-right', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image01', { style: 'tilt-right', speed: 1000, intensity: 5, delay: 0, replay: false });
